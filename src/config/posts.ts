import type { ExternalPost } from "../content/config";
...
export const posts: ExternalPost[] = [
  {
    ...
    image: "/blog-assets/podcast-scaling-frontend-development-challenges-strategies.webp",
  ...
  },
  {
    ...
    image: "/blog-assets/omri-lavi-react-day-berlin-24-the-superpower-of-asts-how-we-saved-16-on-our-bundle-size.jpg",
  },
  {
    ...
    publishDate: new Date("2024-08-07"),
    description: "Omri's talk at ReactNext 24` about the superpower of ASTs and how we saved 16% on our bundle size",
    image: "/blog-assets/omri-lavi-reactnext-24-the-superpower-of-asts-how-we-saved-16-on-our-bundle-size.jpg",
  },
  {
    ...
    publishDate: new Date("2023-06-04"),
    description: "Learn how we optimized live updates with WebSockets to keep your data fresh.",
    image: "/blog-assets/keeping-your-data-fresh-optimizing-live-updates-with-websockets.jpg",
  },
  {
  ...
  },
  {
    ...
    image: "/blog-assets/writing-your-first-custom-stylelint-rule.jpg",
    publishDate: new Date("2020-09-18"),
  },
  {
    ...
    image: "/blog-assets/3-considerations-for-your-next-utility-function-refactor-static-vs-dependency-injected.jpg",
    publishDate: new Date("2019-11-27"),
  },
  {
    ...
    image: "/blog-assets/my-top-9-hand-picked-talks-from-cssconfbp-and-jsconfbp-19.jpg",
    publishDate: new Date("2019-11-26"),
  },
  {
    ...
    image: "/blog-assets/link-previews-more-than-meets-the-eye.jpg",
    publishDate: new Date("2019-09-10"),
  },
  {
    ...
    image: "/blog-assets/cleaner-typescript-with-the-non-null-assertion-operator.jpeg",
    title: "Cleaner TypeScript With the Non-Null Assertion Operator",
    publishDate: new Date("2019-08-25"),
  },
  {
    ...
    image: "/blog-assets/7-things-you-should-know-before-starting-with-side-projects.jpg",
    publishDate: new Date("2019-02-24"),
  },
  {
    ...
    image: "/blog-assets/fixing-overly-aggressive-optimization-with-terser.jpg",
    publishDate: new Date("2019-01-08"),
  },
  {
    url: "https://www.youtube.com/watch?v=Bov9v7Oept4",
    title: "Microfrontends with iFrames",
    image: "/blog-assets/microfrontends-with-iframes.jpg",
    description:
    ...
    publishDate: new Date("2018-12-07"),
  },
];
